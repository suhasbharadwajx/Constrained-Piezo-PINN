...
for ep in range(15000):
    ...
    if (ep + 1) % 1500 == 0:
        print(f"Epoch {ep+1:5d} | e15 = {model.e15_pred.item()*e33_SI:.5f} | Loss: {loss.item():.2e}")
...
print(f"\nFINAL DISCOVERED e15: {final_e15_dim:.5f} C/m^2")
...
ax1.set_title(rf"MMS: Displacement $\bar{{u}}_3$ at t={t_plot}")
...
ax2.set_title(r"Asymmetric Coupled Response ($x_1 = 1.25$)")
...
ax4.set_title("Inverse Parameter Discovery")
